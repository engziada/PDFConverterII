...
### Image: A diagram showing the hierarchy of number sets ($$\mathbb{N} \subset \mathbb{W} \subset \mathbb{Z} \subset \mathbb{Q} \subset \mathbb{R}$$).  
...
$$ \text{المقسوم} = (\text{المقسوم عليه} \times \text{ناتج القسمة}) + \text{الباقي} $$  
### Question:  
...
### Content:
لضرب المصفوفتين $$A$$ (من الرتبة $$m \times n$$) و $$B$$ (من الرتبة $$p \times k$$)، يجب أن يكون عدد أعمدة الأولى مساويًا لعدد صفوف الثانية ($$n=p$$).  
...
### Image: A diagram showing the diagonal method for calculating a 3×3 determinant.  
...
$$ |A| = (1)(-1) - (1)(1) = -2 $$  
$$ A^{-1} = \frac{1}{-2} \begin{bmatrix} -1 & -1 \\ -1 & 1 \end{bmatrix} = \begin{bmatrix} 0.5 & 0.5 \\ 0.5 & -0.5 \end{bmatrix} $$  
