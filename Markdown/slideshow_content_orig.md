...
### Content:
- **مصفوفة صفية:** تتكون من صف واحد فقط. مثال: $$\begin{bmatrix} 1 & 0 & -6 \end{bmatrix}$$  
- **مصفوفة عمودية:** تتكون من عمود واحد فقط. مثال: $$\begin{bmatrix} 2 \\ 9 \end{bmatrix}$$  
...
- **مصفوفة الوحدة (I):** مصفوفة قطرية جميع عناصر قطرها الرئيسي تساوي 1. مثال: $$I_2 = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}$$  
